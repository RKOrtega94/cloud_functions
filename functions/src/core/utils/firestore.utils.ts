...
export class FirestoreUtils {
   ...
   */
  async create(data: any, reference?: string): Promise<any> {
    try {
   ...
   */
  async getById(id: string, reference?: string): Promise<any> {
    try {
   ...
   */
  async update(id: string, data: any, reference?: string): Promise<any> {
    try {
   ...
   * @param id - The id of the document
   */
  async remove(id: string, reference?: string): Promise<void> {
    try {
